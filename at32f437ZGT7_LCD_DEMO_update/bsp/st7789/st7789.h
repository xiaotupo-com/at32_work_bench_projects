...
#define ST7789_COLOR_DEPTH 16// 16bit
#define ST7789_BUFFER_SIZE (ST7789_WIDTH * ST7789_HEIGHT * ST7789_COLOR_DEPTH / 8)
...
public:
    void setBacklight(OnOffState state) const;
...
private:
    void reset() const;
    void setCS(HighLowState state) const;
    void setDC(HighLowState state) const;
...
private:
    ...
    uint8_t buffer[ST7789_BUFFER_SIZE];
};
